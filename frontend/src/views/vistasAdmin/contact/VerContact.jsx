  ...
  return (
    <>
      <ArgonBox py={3}>
        ...
        <Card>
          <ArgonBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
            <ArgonTypography variant="h6">Lista de Contactos</ArgonTypography>
          </ArgonBox>
          <ArgonBox
            sx={{
              "& .MuiTableRow-root:not(:last-child)": {
          ...
          >
            <div className="card">
              ...
              >
                ...
                <Column field="direction" header="Direction" style={{ width: "15%" }}></Column>
                <Column field="email" header="Correo" style={{ width: "15%" }}></Column>
                <Column field="phone" header="Telefono" style={{ width: "10%" }}></Column>

                <Column field="type" header="Mensaje" style={{ width: "50%" }}></Column>
