...
import { apiMascota, enableApiMascota, disableApiMascota } from "config/api";
// Data
const VerMascota = () => {
  ...
  async function getlistData() {
    try {
      const response = await axios.get(apiMascota);
  ...
  return (
    <>
      <ArgonBox py={3}>
        ...
        <Card>
          <ArgonBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
            <ArgonTypography variant="h6">Lista de Mascota</ArgonTypography>
          </ArgonBox>
          <ArgonBox
            sx={{
              "& .MuiTableRow-root:not(:last-child)": {
          ...
          >
            <div className="card">
              ...
              >
                ...
                <Column field="age" header="Edad" style={{ width: "5%" }}></Column>
                <Column field="sex" header="sexo" style={{ width: "25%" }}></Column>
                <Column field="description" header="Descripcion" style={{ width: "35%" }}></Column>
                <Column
                  body={renderStatusVacun}
                  header="Vacunacion"
                  style={{ width: "25%" }}
                ></Column>
                <Column field="date_end" header="Fecha" style={{ width: "25%" }}></Column>
                <Column
                  field="pet_type.name"
                  header="Tipo Mascota"
                  style={{ width: "25%" }}
                ></Column>
                <Column field="type_race.name" header="Tipo Raza" style={{ width: "25%" }}></Column>
