...
import { postApiTipoRaza, putApiTipoRaza, getIdApiTipoRaza } from "config/api";
...
const FromTipoRaza = () => {
  ...
  async function getFrom(e) {
    ...
    if (id) {
      try {
        const response = await axios.put(putApiTipoRaza + id, body);
      ...
      try {
        const response = await axios.post(postApiTipoRaza, body);
        if (response.status === 201) {
          toast.current.show({
            severity: "info",
            summary: "Actualizado",
  ...
  async function getById() {
    try {
      const response = await axios.get(getIdApiTipoRaza + id);
        ...
        <LCard>
          ...
          >
            <div style={{ display: "flex", justifyContent: "center" }}>
              <Card
                title={id ? "Actualizar Tipo de Raza" : "Agregar Tipo de Raza"}
                style={{ width: "90%" }}
              >
                <form>
                  ...
                  <div className="field col-12 md:col-6">
                    ...
                    <div className="field col-12 md:col-6">
                    <Link to={"/teypeRace"} style={{ color: "white" }}>
